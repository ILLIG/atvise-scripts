...
async function printUsage(context) {
  ...
  const description = (_context$script$descr = context === null || context === void 0 || (_context$script = context.script) === null || _context$script === void 0 ? void 0 : _context$script.description) !== null && _context$script$descr !== void 0 ? _context$script$descr : pkg.description;
...
async function runScript(script, scriptName) {
  ...
  const pauseSpinnerAsync = async fn => {
    if (persisted) {
      spinner === null || spinner === void 0 || spinner.stop();
    } else {
      spinner === null || spinner === void 0 || spinner.stopAndPersist();
      persisted = true;
    }
  ...
  try {
    ...
    spinner === null || spinner === void 0 || spinner.succeed(`Finished '${scriptName}' after ${ms(Date.now() - start)}`);
  } catch (error) {
    spinner === null || spinner === void 0 || spinner.fail();
    throw error;
  }
}
