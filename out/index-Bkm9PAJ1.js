...
const deploy = {
  ...deployMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./deploy-BBt5haJW.js'); }))
};
const prepare = {
  ...prepareMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./prepare-Ck97lHmn.js'); }))
};
const init = {
  ...initMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./init-7vnHmmMf.js'); }))
};
