...
const deploy = {
  ...deployMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./deploy-BYFY0EZX.js'); }))
};
const prepare = {
  ...prepareMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./prepare-IzpnpL0v.js'); }))
};
const init = {
  ...initMetadata,
  run: lazyRun(() => Promise.resolve().then(function () { return require('./init-CoFp-Vxo.js'); }))
};
